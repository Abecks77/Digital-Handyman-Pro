        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-zinc-800/50 p-4 rounded-lg border border-zinc-700/30">
              ...
              <div className="space-y-2">
                <div className="h-16 bg-zinc-700/30 rounded border border-zinc-600/20 p-2">
                  <div className="h-2 w-1/2 bg-orange-400/40 rounded mb-2"></div>
                  <div className="h-2 w-3/4 bg-zinc-600/40 rounded"></div>
                </div>
                <div className="h-16 bg-zinc-700/30 rounded border border-zinc-600/20 p-2">
                  <div className="h-2 w-2/3 bg-purple-400/40 rounded mb-2"></div>
            ...
            <div className="bg-zinc-800/50 p-4 rounded-lg border border-zinc-700/30">
              ...
              <div className="space-y-2">
                <div className="h-16 bg-zinc-700/30 rounded border border-zinc-600/20 p-2">
                  <div className="h-2 w-3/4 bg-orange-400/40 rounded mb-2"></div>
      ...
      visual: (
        <div className="space-y-4 pt-4">
           <div className="flex justify-between items-center pb-4 border-b border-zinc-800">
            ...
            <button className="text-xs text-purple-400 bg-purple-950 px-2 py-1 rounded border border-purple-800">+ New Step</button>
          </div>
      ...
      visual: (
        <div className="flex bg-zinc-900 rounded-lg overflow-hidden border border-zinc-800 h-64 mt-4">
           ...
           <div className="w-3/4 p-4 relative">
              ...
              <div className="w-32 h-10 bg-purple-600/50 rounded"></div>
           </div>
        </div>
      )
    },
      ...
      visual: (
        <div className="bg-zinc-900 p-6 rounded-lg border border-zinc-800 max-w-md mx-auto mt-4">
          ...
          <div className="space-y-4">
            ...
            <div className="h-10 w-full bg-purple-600/50 rounded mt-4 flex items-center justify-center text-sm font-medium text-purple-200">Submit Form</div>
          </div>
        </div>
      )
    },
      ...
      visual: (
        <div className="flex h-full min-h-[250px] bg-zinc-900 rounded-lg border border-zinc-800 mt-4 overflow-hidden">
           <div className="w-1/3 border-r border-zinc-800 p-4 space-y-3">
             ...
             <div className="p-2 bg-zinc-800 rounded border-l-2 border-purple-400"><div className="h-3 w-3/4 bg-zinc-600 rounded"></div></div>
           ...
           <div className="w-2/3 p-6 flex flex-col">
             ...
             <div className="flex-1 bg-zinc-950 rounded border border-zinc-800 p-6 flex items-center justify-center">
                 <div className="text-center w-full max-w-xs">
                     ...
                     <div className="h-8 w-1/3 bg-purple-600/50 rounded mx-auto"></div>
                 </div>
             </div>
           </div>
        </div>
      ...
      visual: (
        <div className="max-w-md mx-auto bg-zinc-900 rounded-lg flex flex-col h-[320px] border border-zinc-800 overflow-hidden mt-4">
           ...
           <div className="flex-1 p-4 flex flex-col gap-4 overflow-y-auto">
             <div className="self-end bg-purple-900 p-3 rounded-2xl rounded-tr-sm max-w-[80%]">
                <div className="h-3 w-32 bg-purple-700 rounded mb-2"></div>
                <div className="h-3 w-20 bg-purple-700 rounded"></div>
             </div>
             ...
             <div className="self-end bg-purple-900 p-3 rounded-2xl rounded-tr-sm max-w-[80%]">
                <div className="h-3 w-28 bg-purple-700 rounded"></div>
             </div>
           </div>
           <div className="p-3 border-t border-zinc-800 flex gap-2">
              <div className="h-10 flex-1 bg-zinc-800 rounded-full shrink-0"></div>
              <div className="h-10 w-10 bg-purple-600/50 rounded-full shrink-0 flex items-center justify-center">
        ...
        <div className="bg-zinc-900 p-6 rounded-lg border border-zinc-800 h-full mt-4">
           <div className="flex justify-between items-center mb-6 border-b border-zinc-800 pb-4">
              ...
              <div className="flex gap-2">
                 ...
                 <span className="px-3 py-1 text-xs bg-purple-900 rounded-lg text-purple-400 border border-purple-800">Week</span>
              </div>
           </div>
              ...
              {[1,2,3,4,5].map(i => (
                <div key={i} className="flex flex-col gap-2">
                  ...
                  <div className="flex-1 border-r border-zinc-800/50 relative">
                     {i === 2 && <div className="absolute top-4 left-1 right-1 h-12 bg-orange-900/50 border-l-2 border-orange-500 rounded text-[10px] p-1 text-orange-300">Quote</div>}
    ...
    { 
      ...
      visual: (
        <div className="flex flex-col items-center justify-center p-8 space-y-4">
           ...
           <div className="w-px h-6 bg-purple-500/50 relative">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 rounded-full bg-purple-900 border border-purple-500"></div>
           </div>
           <div className="w-full max-w-sm bg-zinc-800 p-4 rounded-lg border border-zinc-700 flex items-center gap-3 border-l-4 border-l-blue-500">
              <div className="bg-orange-900/50 text-orange-400 p-2 rounded-lg">
        ...
        <div className="grid grid-cols-2 gap-4 col-span-2 md:col-span-1 mt-4">
           <div className="bg-zinc-900 rounded-lg overflow-hidden border border-zinc-800 col-span-2">
              <div className="h-32 bg-zinc-800 flex items-center justify-center relative">
                 <div className="w-12 h-12 bg-purple-600/50 rounded-full flex items-center justify-center absolute z-10">
              ...
              {[1,2,3,4].map(i => (
                <div key={i} className="flex justify-between items-center p-3 bg-zinc-800/50 rounded border border-zinc-700/50 hover:bg-zinc-800 transition-colors">
                   <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-orange-900/30 flex flex-shrink-0 items-center justify-center border border-orange-800/50">
                   ...
                   <div className="text-right">
                      <div className="h-3 w-16 bg-purple-700/80 rounded mb-1 ml-auto"></div>
      ...
      visual: (
        <div className="bg-zinc-900 p-6 rounded-lg border border-zinc-800 mt-4">
           ...
           <div className="p-5 bg-zinc-800/30 rounded-lg border border-zinc-700/50">
              ...
              <div className="h-7 w-24 bg-purple-900/50 text-purple-400 border border-purple-800 rounded text-xs flex items-center justify-center font-medium">Reply instantly</div>
           </div>
        </div>
      )
    },
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
           ...
           <div className="bg-zinc-900 p-5 rounded-xl border border-zinc-800 shadow-sm flex flex-col items-center justify-center">
             ...
             <div className="h-20 w-full flex items-center justify-center">
                <div className="w-20 h-20 rounded-full border-[6px] border-zinc-800 border-r-purple-500 border-t-purple-500 rotate-45 relative shadow-[0_0_15px_rgba(168,85,247,0.2)]"></div>
             </div>
           </div>
           <div className="col-span-2 bg-zinc-900 p-5 rounded-xl border border-zinc-800 shadow-sm">
             ...
             <div className="space-y-4">
               <div className="flex items-center gap-3">
                 ...
                 <div className="flex-1 h-2.5 bg-zinc-800 rounded-full overflow-hidden"><div className="h-full w-[60%] bg-orange-500 rounded-full"></div></div>
                 <div className="text-xs font-mono text-zinc-400">60%</div>
               </div>
               <div className="flex items-center gap-3">
                 <div className="text-xs font-semibold w-16 text-zinc-300">Direct</div>
                 <div className="flex-1 h-2.5 bg-zinc-800 rounded-full overflow-hidden"><div className="h-full w-[30%] bg-purple-500 rounded-full"></div></div>
      ...
      visual: (
        <div className="bg-zinc-900 rounded-xl border border-zinc-800 h-full flex overflow-hidden mt-4 shadow-sm">
           <div className="w-16 bg-zinc-950 border-r border-zinc-800 flex flex-col items-center py-4 gap-4">
              <div className="w-10 h-10 bg-purple-900 rounded-xl border border-purple-700/50 shadow-sm"></div>
      ...
      visual: (
        <div className="bg-zinc-900 p-8 rounded-xl border border-zinc-800 h-full flex flex-col items-center justify-center relative mt-4 shadow-sm overflow-hidden">
           ...
           <div className="w-56 h-64 bg-zinc-100 rounded shadow-2xl p-6 relative origin-bottom -rotate-[4deg] z-10 transition-transform hover:rotate-0 duration-500 border border-zinc-300">
              ...
              <div className="border hover:border-solid border-purple-500 border-dashed rounded p-3 text-center text-[10px] font-bold tracking-wider text-purple-600 bg-purple-50/50 cursor-pointer transition-colors">
                 SIGNATURE HERE
              </div>
           </div>
      ...
      visual: (
        <div className="flex flex-col items-center justify-center h-full p-8 relative overflow-hidden bg-zinc-950 border border-zinc-800 rounded-xl mt-4 shadow-sm">
           <div className="absolute flex items-center justify-center w-full h-full">
               <div className="w-56 h-56 border border-purple-500/20 rounded-full animate-ping" style={{ animationDuration: '3s' }}></div>
               <div className="absolute w-40 h-40 border border-purple-500/30 rounded-full animate-ping" style={{ animationDuration: '2s' }}></div>
               <div className="absolute w-full h-full bg-purple-900/10 blur-3xl"></div>
           </div>
           
           <div className="relative z-10 w-28 h-28 bg-zinc-900 border border-purple-500/50 rounded-full flex items-center justify-center mb-8 shadow-[0_0_40px_rgba(168,85,247,0.4)]">
           ...
           <div className="bg-zinc-800/80 backdrop-blur-md border border-zinc-700 p-5 rounded-2xl relative z-10 w-full max-w-sm space-y-4 shadow-xl">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-xs font-medium text-zinc-300 p-2.5 bg-zinc-900/80 rounded-lg">
                   ...
                   <span className="text-purple-400">Handling Inquiries</span>
                </div>
                <div className="flex items-center justify-between text-xs font-medium text-zinc-300 p-2.5 bg-zinc-900/80 rounded-lg">
    ...
    <div className="grid lg:grid-cols-[350px_1fr] gap-6 bg-zinc-900/50 border border-zinc-800/80 rounded-3xl p-6 shadow-2xl w-full">
      ...
      <div className="hidden lg:flex bg-zinc-950 rounded-2xl border border-zinc-800/80 relative overflow-hidden flex-col h-[500px] lg:h-[600px] shadow-inner shadow-black/50">
        ...
        <div className="p-8 pb-0 z-20 relative">
           ...
           >
              <h3 className="text-xl md:text-2xl font-bold text-white mb-2">{features[activeIndex].title}</h3>
    ...
    <div className="min-h-screen text-zinc-50 font-sans selection:bg-purple-500/30 relative">
      ...
      <div className="relative z-10 flex flex-col">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tighter mb-8 leading-[1.1] text-white text-center lg:text-left">
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-16 relative">
              ...
              {[
                  ...
                  visual: (
                    <div className="relative w-full h-32 bg-zinc-950/50 rounded-xl border border-zinc-800/50 mb-6 flex items-center justify-center overflow-hidden group-hover:border-orange-500/30 transition-colors">
                      ...
                      >
                        ...
                        <div className="h-2 w-3/4 bg-zinc-600 rounded mb-4"></div>
                        <div className="h-6 w-full bg-orange-500 rounded flex items-center justify-center">
                ...
                <motion.div 
                  ...
                  className="bg-zinc-900/80 backdrop-blur-sm border border-zinc-800/80 rounded-2xl p-6 relative z-10 group hover:border-orange-500/50 transition-colors shadow-xl"
                >
                  {step.visual}
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16 relative">
              {[
                    ...
                    <div className="relative w-full h-40 bg-zinc-950/50 rounded-xl border border-zinc-800/50 mb-8 flex items-center justify-center overflow-hidden group-hover:border-slate-500/30 transition-colors">
                      ...
                      <div className="flex gap-3 relative z-10">
                        {[0, 1, 2].map((i) => (
                          ...
                          >
                            <div className={`w-12 h-12 rounded-full border flex items-center justify-center shadow-[0_0_20px_rgba(100,116,139,0.15)] ${i === 1 ? 'bg-slate-500/20 border-slate-500/50 w-14 h-14' : 'bg-orange-500/10 border-orange-500/30'}`}>
                              <User className={`${i === 1 ? 'text-slate-400 w-6 h-6' : 'text-orange-400 w-5 h-5'}`} />
                            </div>
                            <div className={`h-1.5 rounded-full ${i === 1 ? 'bg-slate-500/50 w-10' : 'bg-orange-500/50 w-8'}`}></div>
                          </motion.div>
                        ))}
                      </div>
                ...
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.15 }}
                  className="bg-zinc-900/40 backdrop-blur-sm border border-zinc-800/60 rounded-3xl p-8 relative z-10 group hover:border-orange-500/40 transition-colors text-center shadow-xl"
                >
                  {feature.visual}
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-16 relative">
              ...
              >
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-center mb-12 text-zinc-500">Now</h3>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-8 mb-12">
                  ...
                  <div className="flex flex-col items-center text-center">
                    <div className="w-24 h-24 rounded-2xl bg-orange-900/30 border border-orange-500/50 flex items-center justify-center mb-6 relative group-hover:border-purple-500/50 transition-colors">
                      <ClipboardCheck className="w-12 h-12 text-orange-400 group-hover:text-purple-400 transition-colors" />
                      <motion.div animate={{ y: [-5, 5, -5] }} transition={{ repeat: Infinity, duration: 3, ease: "easeInOut" }} className="absolute -bottom-3 -right-3 bg-zinc-900 rounded-full p-1 border border-orange-500/30 group-hover:border-purple-500/50">
                        <Filter className="w-6 h-6 text-orange-400 group-hover:text-purple-400" />
                      </motion.div>
                    </div>
                    <h4 className="font-bold text-orange-100 tracking-wider group-hover:text-purple-200 transition-colors">Qualified Leads</h4>
                  </div>
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h4 className="font-bold text-orange-100 tracking-wider group-hover:text-orange-200 transition-colors">Peace of Mind</h4>
                  </div>
                  
                  <div className="flex flex-col items-center text-center">
                    <div className="w-24 h-24 rounded-2xl bg-orange-900/30 border border-orange-500/50 flex items-center justify-center mb-6 relative overflow-hidden group-hover:border-slate-500/50 transition-colors">
                      <TrendingUp className="w-12 h-12 text-orange-400 relative z-10 group-hover:text-slate-400 transition-colors" />
                      <motion.div 
                    ...
                    <h4 className="font-bold text-orange-100 tracking-wider group-hover:text-slate-200 transition-colors">Growth</h4>
                  </div>
                </div>
                
                <div className="text-center pt-8 border-t border-orange-500/30">
                  <p className="text-orange-200 font-medium text-xl">
                    Consistent leads, <span className="text-orange-400 font-bold">smooth operation</span> <br/>
                    & <span className="text-orange-400 font-bold">predictable revenue</span>
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                      ...
                      <motion.div animate={{ y: [0, -5, 0] }} transition={{ repeat: Infinity, duration: 3 }} className="relative z-10 flex gap-4">
                        <div className="w-16 h-24 rounded-xl border border-orange-500/30 bg-zinc-950 flex flex-col items-center justify-center shadow-[0_0_20px_rgba(59,130,246,0.2)] overflow-hidden">
                           <div className="w-10 h-16 bg-orange-900/20 rounded overflow-hidden p-1 flex flex-col gap-1.5 justify-center">
                             <motion.div initial={{ opacity: 0, x: -5 }} animate={{ opacity: 1, x: 0 }} transition={{ repeat: Infinity, duration: 2 }} className="w-3/4 h-2 bg-orange-400/50 rounded self-start"></motion.div>
                             ...
                             <motion.div initial={{ opacity: 0, x: -5 }} animate={{ opacity: 1, x: 0 }} transition={{ repeat: Infinity, duration: 2, delay: 1 }} className="w-3/4 h-2 bg-orange-400/50 rounded self-start"></motion.div>
                           </div>
                        </div>
                      </motion.div>
                ...
                >
                  <div className="relative w-full h-48 bg-zinc-950/50 rounded-xl border border-zinc-800/50 mb-8 flex items-center justify-center overflow-hidden group-hover:border-purple-500/30 transition-colors">
                      ...
                      <div className="relative z-10 flex flex-col items-center gap-3">
                        ...
                        <div className="w-12 h-12 rounded-full bg-purple-500/10 border border-purple-500/30 flex items-center justify-center shadow-[0_0_15px_rgba(168,85,247,0.15)] my-1">
                          <UserCheck className="w-6 h-6 text-purple-400/70" />
                        </div>
                        <motion.div animate={{ scaleX: [1, 0.8, 1] }} transition={{ repeat: Infinity, duration: 2 }} className="w-16 h-2.5 bg-purple-400/60 rounded-full shadow-[0_0_10px_rgba(168,85,247,0.3)]"></motion.div>
                        <motion.div animate={{ scaleX: [1, 0.6, 1] }} transition={{ repeat: Infinity, duration: 2, delay: 0.2 }} className="w-10 h-2.5 bg-purple-400/60 rounded-full shadow-[0_0_10px_rgba(168,85,247,0.3)]"></motion.div>
                      </div>
                      <motion.div animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 10, ease: "linear" }} className="absolute border border-purple-500/10 w-48 h-48 rounded-full border-dashed"></motion.div>
                      <motion.div animate={{ opacity: [0.1, 0.4, 0.1] }} transition={{ repeat: Infinity, duration: 3 }} className="absolute bg-purple-500/20 blur-2xl w-32 h-32 rounded-full"></motion.div>
                  </div>
                  <div>
                    <h3 className="text-xl md:text-2xl font-bold text-white mb-3 tracking-wide">The Lead Qualifier</h3>
                    <p className="text-zinc-400 leading-relaxed">
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xl md:text-2xl font-bold text-white mb-3 tracking-wide">The Scheduling Assistant</h3>
                    <p className="text-zinc-400 leading-relaxed">
                ...
                >
                  <div className="relative w-full h-48 bg-zinc-950/50 rounded-xl border border-zinc-800/50 mb-8 flex items-center justify-center overflow-hidden group-hover:border-orange-500/30 transition-colors">
                      ...
                      <div className="relative z-10 w-24 h-24 flex items-center justify-center">
                        ...
                        <motion.div animate={{ scale: [0.8, 1.1, 0.8] }} transition={{ repeat: Infinity, duration: 2 }} className="w-12 h-12 rounded-full bg-orange-500/10 border border-orange-500/30 flex items-center justify-center backdrop-blur-sm shadow-[0_0_15px_rgba(59,130,246,0.3)]">
                           <RefreshCw className="w-5 h-5 text-orange-400" />
                        </motion.div>
                      </div>
                      <motion.div animate={{ opacity: [0, 1, 0], y: [10, -20] }} transition={{ repeat: Infinity, duration: 2.5 }} className="absolute right-12 top-10 w-8 h-8 bg-zinc-900 rounded-lg border border-purple-500/30 flex items-center justify-center shadow-[0_0_10px_rgba(168,85,247,0.2)]"><Mail className="w-4 h-4 text-purple-400/80"/></motion.div>
                      <motion.div animate={{ opacity: [0, 1, 0], y: [10, -20] }} transition={{ repeat: Infinity, duration: 2.5, delay: 1.2 }} className="absolute left-12 bottom-10 w-8 h-8 bg-zinc-900 rounded-lg border border-orange-500/30 flex items-center justify-center shadow-[0_0_10px_rgba(59,130,246,0.2)]"><MessageSquare className="w-4 h-4 text-orange-400/80"/></motion.div>
                  </div>
                  <div>
                    <h3 className="text-xl md:text-2xl font-bold text-white mb-3 tracking-wide">The Follow-Up Machine</h3>
                    <p className="text-zinc-400 leading-relaxed">
            ...
            <div className="bg-zinc-900/40 backdrop-blur-sm border border-zinc-800/80 rounded-3xl overflow-hidden shadow-2xl">
              ...
              {[
                ...
                <div key={i} className="grid grid-cols-3 border-b border-zinc-800/50 last:border-0 hover:bg-zinc-800/30 transition-colors">
                  ...
                  <div className="p-5 md:p-8 text-white border-l border-zinc-800/80 bg-orange-500/5 flex items-center gap-3 font-semibold text-sm md:text-base">
        ...
        <section className="py-24 relative border-t border-zinc-800/50 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-center tracking-tight leading-tight">
                <span className="relative inline-block">
                  Get Access to <GradientText>Your Ghost Employee</GradientText>
                  <motion.div 
                    initial={{ width: 0 }}
                    whileInView={{ width: "100%" }}
                    viewport={{ once: true }}
        ...
        <section className="py-24 relative border-t border-zinc-800/50 overflow-hidden bg-zinc-950/30">
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-center tracking-tight leading-tight">
                Features with <GradientText>Ascension Subscription</GradientText>
              </h2>
        ...
        <section className="py-32 relative">
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-center lg:text-left tracking-tight leading-tight">
                  <span className="relative inline-block">
                ...
                <p className="text-xl text-zinc-400 mb-10 leading-relaxed text-center lg:text-left">
                ...
                <div className="space-y-8 mb-12">
                  <div className="flex items-start gap-5">
                    <div className="w-14 h-14 rounded-full bg-zinc-900/80 border border-zinc-800 flex items-center justify-center text-orange-400 flex-shrink-0 shadow-lg">
                      <CheckCircle2 className="w-7 h-7" />
                    </div>
                    <div>
                      <h4 className="font-bold text-xl mb-1">Anytime Support</h4>
                      <p className="text-zinc-400 leading-relaxed">Reach out to our team whenever you need help optimizing your automations, adjusting settings, or managing your account. We're here to help you succeed.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-5">
        ...
        <footer className="border-t border-zinc-800/50 pt-16 pb-8 bg-zinc-950/50 backdrop-blur-md">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-12">
              ...
              <div>
                <h4 className="font-bold text-white mb-5 tracking-wider text-sm">Service Areas</h4>
            ...
            <div className="border-t border-zinc-800/80 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <p className="text-zinc-500 text-sm font-medium flex items-center gap-1.5 flex-wrap sm:flex-nowrap justify-center md:justify-end text-center md:text-right">
